  ...
  <div id="vue1"  class="main_cont">
    ...
    <div class="clear">
 	...
 	<div class="info" v-if="userInfo.id">
 		<p @click="clickHandle">姓名:{{userInfo.name}}</p>
 		<p @click="clickHandle2">性别:{{userInfo.sex}}</p>
 		<p>年龄:{{userInfo.age}}</p>
 	</div>
 	<div v-if="userInfo.id" class="info_list clear">
 		<router-link exact to='?info=fl'>信息1</router-link>
