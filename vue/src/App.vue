<template>
  <div id="app">
    <ul class="clear">
      <li><router-link exact :to="index">首页</router-link></li>
...
export default {
  ...
  watch:{
    $route(to,from){
      ...
      this.trans = to.meta.index>from.meta.index?'right':'left'
    }
  }
}
</script>
